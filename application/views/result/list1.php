...
<div class="content_wrap">
    <div class="body_title" style="position:relative;">발송결과
        <?php
            $g_placeholder = '제목으로 검색';
            $g_search_action = 'result/list1';
    ...
    <div style="margin-bottom:15px">
        <table width="100%" border="0" cellspacing="0" cellpadding="1">
            <tr>
            <td align="right"></td>
            <td width="80"><div class="style_btn" style="width:70px"><a href="#" onclick="deleteCampaign();">내역삭제</a></div></td>
            </tr>
        </table>
    </div>
    <div class="board">
    <?php
        ...
        echo form_open('/result/list1', $attributes);
    ?>
    <?php
        $data = array(
            'chk_nums' => '',
        ...
        ?>
                <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F4F4F4';return true;" onMouseOut="this.style.backgroundColor=''; return true;">
                    ...
                    <?php if ($row->status == '100') { ?>
                        <input type="checkbox" name="chk_seq_no" value="<?=$row->procid?>" />
                    <?php } ?>
                    </td>
...
var deleteCampaign = function () {
    ...
    $("form#frmCampaign").attr("action", "/result/delete_list1");
