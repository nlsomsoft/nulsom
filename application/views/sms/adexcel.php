		...
		<tr>
			...
			<td width="960" valign="top">
				...
				<div class="content_wrap">
					<div class="body_title" style="position:relative;">단문.장문 - 파일 (Excel)
						<div class="faq_sch">
...
echo form_open_multipart('send/sms_excel', $attributes);
															...
															<table width="90%" border="0" cellspacing="0" cellpadding="0">
																...
																<tr>
																	<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
																		...
																		<tr>
																			<td>
																				<img src="/images/ico_num2_1.gif" align="absmiddle" alt=""> 확장자 .xlsx .xls 파일만 가능 <br />
																				<img src="/images/ico_num2_2.gif" align="absmiddle" alt=""> 최대 50,000개까지 등록가능 <br />
																				<img src="/images/ico_num2_3.gif" align="absmiddle" alt=""> A열 핸드폰 번호, B열 이름 입력 <br />
																				...
																				01012345678 | <br />
																				010-1234-5678 <br />
																				<span style="color:#1f7cc8;">* B열 이름 (선택사항)</span>
																			</td>
																		</tr>
																	</table></td>
																</tr>
