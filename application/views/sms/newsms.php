		...
		<tr>
			...
			<td width="960" valign="top">
				...
				<div class="content_wrap">
					<div class="body_title" style="position:relative;">단문.장문  <img src="/images/vote_icon.png">
						<div class="faq_sch">
								...
								<table width="100%" border="1" style="border: 1px solid #bbb; margin-top:20px" cellpadding="0" cellspacing="1" bgcolor="#fff" class="class_tbl">
									<tr border="1" style="border: 1px solid #bbb;">
										...
										<td width="300" bgcolor="#FFFFFF" align="center">
											<input type="text" name="subject" id="msg_subject" maxlength="50" style="width:90%;" class="input_261" placeholder="제목입력(최대 50byte, 특수문자 제외)" value="<?=$cached_campaign_array['subject']?>" />
										</td>
...
var changeBodyForm1 = function (v1) {
	var change_byte = 90;
	var limit_byte = 2000;	var bytes = document.getElementById("msgbody").value.bytes2();
	if ($("input[name=vote_flag]").val() == '2') bytes += add_vote_byte;
	document.getElementById("msgByte").innerHTML = bytes;
	if (bytes > change_byte) {
		$("#msgType").html("<strong>장문</strong>");
