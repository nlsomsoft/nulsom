		...
		<tr>
			...
			<td width="960" valign="top">
				...
				<div class="content_wrap">
					<div class="body_title" style="position:relative;">단문.장문 - 텍스트
						<div class="faq_sch">
...
echo form_open('send/text_sms', $attributes);
																	...
																	<td height="90"><table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tr>
																			...
																			<table width="100%" border="0" cellspacing="0" cellpadding="0">
																			 <tr>
																			 	<td>
																					<textarea id="bulklist_telnumlist" name="bulklist_telnumlist" style="width:160px; height:220px; resize: none;" wrap="VIRTUAL" class="inputbulkbody"></textarea>
																				</td>
																			  <td>
																			  	<div style="padding-left:5px;font-size:12px;">
																				  	<img src="/images/ico_num2_1.gif" align="absmiddle" alt=""> 최대 50,000개까지 등록가능<br />
																				  	<img src="/images/ico_num2_2.gif" align="absmiddle" alt=""> 핸드폰번호,이름 순으로 입력<br />
																				  	<img src="/images/ico_num2_3.gif" align="absmiddle" alt=""> 입력 예시<br />
																				  	10-1234-5678<br />
																				  	<span style="color:#337ab7;">* 맨 앞 '0'이 없으면 '0' 자동 입력</span> <br />
																				  	019)00000000 |<br />
																				  	010-0000-0000<br />
																				  	01012345678 | 홍길동<br />
																				  	<span style="color:#1f7cc8;">* 이름 (선택사항)</span>
																				  </div>
																			  </td>
																			 </tr>
																			</table>
...
function registerMessages() {
  ...
  var listcount = bulklist_order_list();
	if (listcount < 1) {
		alert("받는사람이 없습니다.");
		return false;
	}
	$("input[name=bulk_count").val(listcount);
...
function bulklist_check_list() {
	var listcount = bulklist_order_list();
	$("input[name=bulklist_listcount").val("[총 " + listcount + " 명]");
	$("input[name=bulk_count").val(listcount);
	if (listcount > 0) obj.enabled = true;
	bulklist_telnumlist_enabled = true;
	return listcount;
}
function bulklist_order_list() {
	var bt_val = $("textarea#bulklist_telnumlist").val();
	if (bt_val == "") return 0;
	...
	// obj.value = HTML;
	$("textarea#bulklist_telnumlist").val(HTML);
