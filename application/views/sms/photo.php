...
<div class="body-inner-table" style="padding-top:20px; min-height:700px;">
	...
	<table width="1200" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<?php
				$g_left_menu_flag = ($svc == 'elect' ? 'elect_sms' : 'sms');
			...
			<td width="960" valign="top">
				...
				<div class="content_wrap">
					<div class="body_title" style="position:relative;">포토문자
						<div class="faq_sch">
											...
											<td width="380" valign="top" align="center" bgcolor="#FFFFFF">
												...
												<div class="phone_bg">
													...
													<div style="height:150px; line-height:150px; vertical-align:middle">
														<a href="/sms/photo_popup" onclick="winPop(this.href, {name:'inputPhotoPop',width:410,height:500}); return false;" class="inputPhotoPop" style="text-align:left;padding-left:14px;"><img src="/images/img_up.png" id="photo_image" style="width:auto; max-height:150px" /></a>
													</div>

														<div class="msg_sub_color" style="margin-top:10px;">
															<input id="votemsgtop" name="vote_msg_top" type="text" class="phone_bg_msg" style="display:none;font-weight:600;font-size:13px;color:#4576c7;" value="<?=($svc == 'elect' ? '(선거운동정보)' : '(광고)')?>" readonly />
											...
											<td width="560" valign="top" bgcolor="#FFFFFF">
												...
												<table width="100%" border="1" style="border: 1px solid #bbb;" cellpadding="0" cellspacing="1" bgcolor="#fff" class="class_tbl">
													<tr border="1" style="border: 1px solid #bbb;">
														...
														<td width="410" bgcolor="#FFFFFF" align="center"><input type="text" name="subject" id="msg_subject" maxlength="50" style="width:90%;" class="input_261" placeholder="제목입력(최대 50byte, 특수문자 제외)" value="<?=$cached_campaign_array['subject']?>" /></td>
													</tr>
													<tr border="1" style="border: 1px solid #bbb;">
																			...
																			<td width="60%" colspan="2">
																				...
																				<span class="bot_btn">
																					<span class="bc bc_wht">
																						<span style="width:115px;"><a href="/append/group_popup" onclick="winPop(this.href, {name:'inputDataPop',width:620,height:700}); return false;" class="inputDataPopup" style="text-align:left;padding-left:14px;">주소록불러오기</a></span>
																					</span>
																				</span>
																				<span class="bot_btn">
																					<span class="bc bc_wht">
																						<span style="width:115px;"><a href="/append/text_popup" onclick="winPop(this.href, {name:'inputDataPop',width:620,height:700}); return false;" class="inputDataPopup" style="text-align:left;padding-left:19px;">파일붙여넣기</a></span>
																					</span>
																				</span>
																				<span class="bot_btn">
																					<span class="bc bc_wht">
																						<span style="width:115px;"><a href="/append/excel_popup" onclick="winPop(this.href, {name:'inputDataPop',width:620,height:700}); return false;" class="inputDataPopup" style="text-align:left;padding-left:19px;">엑셀붙여넣기</a></span>
																					</span>
																				</span>
