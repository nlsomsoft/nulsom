		...
		<tr>
			...
			<td width="960" valign="top">
				...
				<div class="content_wrap">
					<div class="body_title" style="position:relative;">단문.장문 - 파일 (Text)
						<div class="faq_sch">
...
echo form_open_multipart('send/sms_file', $attributes);
															...
															<table width="90%" border="0" cellspacing="0" cellpadding="0">
																...
																<tr>
																	<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tr>
																			<td width="100%">
																				<div class="fileBox previewImage">
																				  <input class="uploadFileName" id="uploadFileName" value="파일선택" disabled="disabled" style="width: 300px;">
																				  <label for="text_file">업로드</label>
																				<input type="file" name="text_file" id="text_file" class="inputHidden">
																				</div>
																			</td>
																		</tr>
																		<tr><td>&nbsp;</td></tr>
																		<tr>
																			<td>
																				<img src="/images/ico_num2_1.gif" align="absmiddle" alt=""> 확장자 .txt 파일만 가능 <br />
																				<img src="/images/ico_num2_2.gif" align="absmiddle" alt=""> 최대 50,000개까지 등록가능 <br />
																				<img src="/images/ico_num2_3.gif" align="absmiddle" alt=""> 핸드폰번호,이름 순으로 입력 <br />
																				<img src="/images/ico_num2_4.gif" align="absmiddle" alt=""> 입력 예시 <br />
																				1012345678 <span style="padding-left:5px;color:#337ab7;">( 맨 앞 '0' 이 없으면 '0' 자동 입력 )</span> <br />
																				010-1234-5678 | 홍길동 <br />
																				01012345678 | <br />
																				010-1234-5678 <br />
...
function registerMessages() {
	...
	var file_ext = uploadFileName.split(".").pop();
	if (file_ext != "txt") {
		alert("텍스트 파일을 업로드 하세요.");
		return false;
	}
