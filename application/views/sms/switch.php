												...
												<div class="phone_bg">
													<div class="phone_bg_inner msg_sub_color2" style="background-color:#deeaf5;">
														...
														<div class="msg_sub_color2" style="margin-top:10px;">
															<input id="votemsgtop2" name="vote_msg_top" type="text" class="phone_bg_msg" style="display:none;font-weight:600;font-size:13px;color:#4576c7;" value="<?=($svc == 'elect' ? '(선거운동정보)' : '(광고)')?>" readonly />
