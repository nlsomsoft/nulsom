...
echo form_open('admsend/filter_update', $attributes);
?>
...
<div class="tbl_wrap tbl_head01">
    ...
    <tbody>
        <tr>
            <td style="width:100px; text-align:center;">금지어</td>
            <td><input type="text" name="word" id="word" value="<?=$filter['word']?>"  class="form-control" style="width:800px; font-size:12px;" minlength="1" required="" /></td>
        </tr>
