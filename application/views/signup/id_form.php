...
<div class="content_wrap">
    ...
    <?php
        $attributes = array(
            'name' => 'frmSignup',
            'id' => 'frmSignup',
            'onsubmit' => 'return findUserId();'
        );
        echo form_open('/signup/find_id', $attributes);
    ?>
		<table width="100%">
			...
			<tr><td align="center">
				<table width="40%">
                    <tr>
                    	<td width="23%" height="40"><span style="font-size:13px; color:#666">이름</span></td>
                    	<td width="77%">
                    		<input name="ipt_name" id="ipt_name" class="input_36" style="width:100%; background:#efefef" minlength="2" maxlength="10" />
                    	</td>
                    </tr>
                    <tr>
                    	<td height="40"><span style="font-size:13px; color:#666">휴대폰번호</span></td>
                    	<td>
                    		<input class="input_36" name="ipt_mobile" id="ipt_mobile" style="width:100%; background:#efefef" maxlength="13" />
                    	</td>
                    </tr>
			    </table>
			</td></tr>
            <tr><td align="center" valign="middle"><div class="bot_btn"><input type="submit" id="signup-button" class="sowsms-inp-submit" value="아이디 찾기" /></div></td></tr>
