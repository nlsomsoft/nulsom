...
$sql = "
	SELECT COUNT(*) cnt
	FROM SDK_SMS_REPORT_A a, SDK_SMS_REPORT_DETAIL_A b
	WHERE a.reserved5 = 'N'
		AND a.reserved1 > '0'
		AND b.tcs_result >= '0'
...
$sql = "
	UPDATE SDK_SMS_REPORT_A a, SDK_SMS_REPORT_DETAIL_A b
...
$sql = "
	DELETE FROM SDK_SMS_REPORT_DETAIL_A
	WHERE subjob_id  = 9
";
if (!mysqli_query($conn, $sql)) {
    error_log('['.$log_name.'][E]...['.$sql.']['.$file_name.']', 0);
